        ...
        <div class="mb-8 flex items-center gap-5">
            ...
            <div>
                ...
                <p class="text-slate-500 text-sm font-medium tracking-wide">
                    Perbarui informasi untuk siswa <b>{{ $student->name }}</b> di bawah ini.
                </p>
            </div>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="nisn" value="{{ old('nisn', $student->nis) }}"
                                    class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-medium text-slate-800 focus:bg-white focus:ring-4 focus:ring-blue-100 focus:border-blue-400 transition-all outline-none"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select name="class_id"
                                    class="w-full pl-11 pr-10 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-medium text-slate-800 focus:bg-white focus:ring-4 focus:ring-blue-100 focus:border-blue-400 transition-all outline-none appearance-none cursor-pointer" required>
